...
export class CometChatMessageThreadComponent implements OnInit, OnChanges {
  ...
  ngOnChanges(change: SimpleChanges) {
    if (change["parentMessage"]) {
      if (
        change["parentMessage"].previousValue &&
        change["parentMessage"].previousValue.id !==
          change["parentMessage"].currentValue.id
      ) {
        let type = change["parentMessage"].currentValue.type;
