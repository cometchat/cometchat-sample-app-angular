...
import { CometChatConversationList } from "../cometchat-chat-uikit-angular/CometChatWorkspace/src/components/Chats/CometChat-conversation-list/cometchat-conversation-list.module";
import { CometChatConversationListWithMessages } from "../cometchat-chat-uikit-angular/CometChatWorkspace/src/components/Chats/CometChat-conversation-list-with-messages/cometchat-conversation-list-with-messages.module";
import { CometChatGroupList } from "../cometchat-chat-uikit-angular/CometChatWorkspace/src/components/Groups/CometChat-group-list/cometchat-group-list.module";
import { CometChatGroupListWithMessages } from "../cometchat-chat-uikit-angular/CometChatWorkspace/src/components/Groups/CometChat-group-list-with-messages/cometchat-group-list-with-messages.module";
import { CometChatUI } from "../cometchat-chat-uikit-angular/CometChatWorkspace/src/components/CometChatUI/CometChat-Ui/cometchat-ui.module";
import { CometChatUserList } from "../cometchat-chat-uikit-angular/CometChatWorkspace/src/components/Users/CometChat-user-list/cometchat-user-list.module";
import { CometChatUserListWithMessages } from "../cometchat-chat-uikit-angular/CometChatWorkspace/src/components/Users/CometChat-user-list-with-messages/cometchat-user-list-with-messages.module";
import { CometChatAvatar } from "../cometchat-chat-uikit-angular/CometChatWorkspace/src/components/Shared/CometChat-avatar/cometchat-avatar.module";
@NgModule({
  declarations: [
    AppComponent,
